...
echo "\n╔════════════════════════════════════════════════════════════════╗\n";
echo "║       UPDATE/CREATE USER AS SUPER_ADMIN                        ║\n";
echo "╚════════════════════════════════════════════════════════════════╝\n\n";
...
if (!$user) {
    echo "⚠️  User tidak ditemukan dengan email: $email\n\n";
    echo "Opsi:\n";
    echo "1. Jika user sudah terdaftar, cek email yang benar\n";
    echo "2. Jika user baru, harus dibuat dulu melalui registrasi\n\n";
    exit(1);
}
